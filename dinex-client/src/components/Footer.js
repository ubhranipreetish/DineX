...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-[#FFF8E7] to-[#F4D483] border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-4 lg:px-6 pt-6 pb-3">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-[#8B6F3E] text-sm mt-3 font-medium">
        ...
        <div className="h-px bg-gray-800/30" />
        ...
        <div className="flex flex-wrap items-center justify-between mt-4">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <button className="flex items-center gap-2 bg-black text-white px-4 pt-2 pb-3 rounded-lg hover:bg-gray-800 transition shadow-md hover:shadow-lg">
            ...
            <button className="flex items-center gap-2 bg-black text-white px-4 pt-2 pb-3 rounded-lg hover:bg-gray-800 transition">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        ...
        <div className="h-px bg-gray-800/30 mt-4" />

        {/* ===== Copyright ===== */}
        <div className="text-center text-xs text-[#8B6F3E] pt-4">
          <p>
            © 2025 <span className="font-semibold text-[#8B6F3E]">DineX</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
