                ...
                <div className="flex flex-col lg:flex-row min-h-[700px]">
                    ...
                    <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center overflow-y-auto">
                        <div className="max-w-md mx-auto w-full">
                            <h2 className="text-3xl font-bold text-[#E6B65C] mb-2">Create Account</h2>
                            <p className="text-gray-600 mb-6">Create your account and start your culinary journey</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="flex items-start">
                                    ...
                                    <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                                        I agree to the{' '}
                                        <span className="text-[#8B6F3E] hover:text-[#C9A050] font-medium">
                                            Terms of Service
                                        </span>{' '}
                                        and{' '}
                                        <span className="text-[#8B6F3E] hover:text-[#C9A050] font-medium">
